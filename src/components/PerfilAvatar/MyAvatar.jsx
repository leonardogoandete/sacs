import { Avatar, Menu, MenuButton, MenuList, MenuItem, useColorMode } from "@chakra-ui/react";
...
function MyAvatar() {
  ...
  return (
    <Menu>
      ...
      <MenuList maxW="200px" minW="200px" color={isDark? "white" : "black"}>
        <MenuItem icon={<BsPersonFillGear />}>Perfil</MenuItem>
        <MenuItem icon={<HiMoon />} isChecked={isDark} onClick={toggleColorMode}>
          Modo Noturno
        </MenuItem>
